...
## Три способа изображения матрицы расстояний {.smaller .columns-2}
...
## Наиболее популярные меры расстояния {.smaller .columns-2}
...
## Коэффициенты для бинарных данных  {.columns-2}
...
>- Существует два подхода к анализу многоменых данных: (1) подход, основанный на линейной алгебре, (2) подход, основанный на исследовании матриц сходства/различия между объектами.
