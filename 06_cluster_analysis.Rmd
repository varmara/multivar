...
```{r ani-dat, include=FALSE, cache=TRUE}
# Данные
dat <- data.frame(x = c(8, 18, 27, 32, 38, 50), y = c(40, 38, 10, 30, 60, 35))
...
```{r single-ani, echo=FALSE, fig.width=8, fig.height=5, fig.show='animate', interval=2, animation.hook='gifski', aniopts='control,loop', results='hide'}
...
```{r complete-ani, echo=FALSE, fig.width=8, fig.height=5, fig.show='animate', interval=2, animation.hook='gifski', aniopts='control,loop', results='hide'}
...
```{r average-ani, echo=FALSE, fig.width=8, fig.height=5, fig.show='animate', interval=2, animation.hook='gifski', aniopts='control,loop', results='hide'}
...
```{r ward-ani, echo=FALSE, fig.width=8, fig.height=5, fig.show='animate', interval=2, animation.hook='gifski', aniopts='control,loop', results='hide'}
