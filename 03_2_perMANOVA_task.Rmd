...
opts_chunk$set(tidy = FALSE, fig.width = 7, fig.height = 3, warning = FALSE)
```
...
<a data-flickr-embed="true" href="https://www.flickr.com/photos/riversdale_estate/23857418673" title="Riversdale Estate Vineyard - vineyard panorama"><img src="https://c1.staticflickr.com/2/1547/23857418673_486462c2df_n.jpg" width="320" height="240" alt="Riversdale Estate Vineyard - vineyard panorama" style="display: block;margin: auto;"></a><script async src="//embedr.flickr.com/assets/client-code.js" charset="utf-8"></script>
...
my_map <- get_map(location = c(lon = centroid[1], lat = centroid[2]), color = "color", source = "google", maptype = "satellite", zoom = 7)
map_small <- ggmap(my_map) +
  geom_point(aes(x = lon, y = lat),
             data = coord, shape = 19,
             colour = "orange") +
  xlim(144.7, 148.3) + ylim(-41.9, -40.5) +
