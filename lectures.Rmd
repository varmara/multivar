...
## 8. Анализ главных компонент (Principal Component Analysis, PCA) (пн 22 марта, МВ)

```{r eval=FALSE}
install.packages(c("cowplot", "geomorph"))
```

__Анализ главных компонент__

- Презентация [html](08_PCA.html)

- Код: [08_PCA.R](08_PCA.R)
- Данные: [protein.csv](data/protein.csv)
- Задание: [08_PCA_breast_cancer_task.R](08_PCA_breast_cancer_task.R)

__(Геометрическая) морфометрия__

- Презентация [html](08_PCA_geometric_morphometrics.html)

- Код: [08_PCA_geometric_morphometrics.R](08_PCA_geometric_morphometrics.R)
- Данные: [turtles.txt](data/turtles.txt)
- Задание: [08_PCA_geometric_morphometrics_task.R](08_PCA_geometric_morphometrics_task.R)

## 9. Анализ избыточности (Redundancy analysis, RDA) (пн 29 марта, МВ)
...
## 10. Корреспондентный анализ (Corespondence Analysis, CA) (пн 5 апреля, ВХ)
...
## 11. Канонический корреспондентный анализ (Canonical Correspondence Analysis, CCA) (пн 12 апреля, ВХ)
