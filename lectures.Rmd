...
Это архивная версия курса. Последний раз таким составом авторов курс был прочитан весной 2022-23г.</span>

Современная версия [здесь](https://polydora.github.io/multivar/)
...
## 8. Анализ главных компонент (Principal Component Analysis, PCA)
...
## 9. Корреспондентный анализ (Corespondence Analysis, CA)
...
## 10. Анализ избыточности (Redundancy analysis, RDA)
...
## 11. Канонический корреспондентный анализ (Canonical Correspondence Analysis, CCA)
...
## 12. Анализ избыточности, основанный на расстояниях (distance-based Redundancy Analysis, dbRDA)
