...
В таблице ниже даны результаты нескольких сравнений. С помощью поправки Хольма Бонферрони для каждой доверительной вероятности $p_j$ мы получим свое скорректированное значение $\hat{p_{j}}$. 
