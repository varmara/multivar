...
## Описание связи нескольких переменных - построение матрицы ассоциации {.smaller .columns-2}
...
## Пересчитываем координаты точек в новом пространстве {.columns-2}
...
## Сравним результаты {.smaller .columns-2}
...
## В данном случае, результаты PCA похожи на nMDS {.olumns-2}
...
grid.arrange(p_scores, nMDS, nrow = 2)
```
